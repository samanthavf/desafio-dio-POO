Desafio: Aprenda na Prática Programação Orientada a Objetos - Abstraindo um Bootcamp
Este material adicional pertence ao desafio: APRENDENDO NA PRÁTICA O PARADIGMA DE ORIENTAÇÃO A OBJETOS
de autoria da excelente instrutora Camila Cavalcante em parceria com a DIGITAL INNOVATION ONE. 💛🧡 Essas informações descrevem os conhecimentos necessários para que fosse possível o cumprimento do desafio e tal aprendizado foi disponibilizado de forma gratuita para a comunidade dos desenvolvedores Java.
💎 O objetivo principal desse desafio é colocar em prática umas das principais ferramentas da Orientação a Objetos: ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO, através de um projeto Java.
